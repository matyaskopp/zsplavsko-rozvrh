\definecolor{podrouzkova}{HTML}{41bfef}
\definecolor{koppova}{HTML}{41bfef}
\definecolor{slamova}{HTML}{a95299}
...
\newcommand{\podrouzkova}{\raisebox{-1em}{\hspace{1em}\tikz\node [inner sep=10pt,draw=podrouzkova,fill=podrouzkova!10,rounded corners=1mm,line width=0.5mm] (0,0) {\textbf{p. uč. Martina Podroužková}};\hspace{1em}}}
\newcommand{\augustinova}{\raisebox{-1em}{\hspace{1em}\tikz\node [inner sep=10pt,draw=augustinova,fill=augustinova!10,rounded corners=1mm,line width=0.5mm] (0,0) {\textbf{p. uč. Kateřina Augustinová}};\hspace{1em}}}
\newcommand{\koppova}{\raisebox{-1em}{\hspace{1em}\tikz\node [inner sep=10pt,draw=koppova,fill=koppova!10,rounded corners=1mm,line width=0.5mm] (0,0) {\textbf{p. uč. Martina Koppová}};\hspace{1em}}}
\newcommand{\slamova}{\raisebox{-1em}{\hspace{1em}\tikz\node [inner sep=10pt,draw=slamova,fill=slamova!10,rounded corners=1mm,line width=0.5mm] (0,0) {\textbf{p. uč. Magdaléna Slámová}};\hspace{1em}}}
